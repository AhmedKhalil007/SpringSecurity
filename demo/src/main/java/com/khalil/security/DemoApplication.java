...
public class DemoApplication {
    ...
    void init_users() {
        ...
        userService.saveUser(new User(null,"admin","efsgr",true,null));
        userService.saveUser(new User(null, "emna","123fgsd",true,null));
        userService.saveUser(new User(null, "mohamed","123qqq",true,null));
